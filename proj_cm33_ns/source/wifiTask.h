 ...
 * results. For example, MAC Address: 5A:CF:20:AE:90:52 should be entered as
 * shown below.
 */
#define SCAN_FOR_MAC_ADDRESS                 0x5A, 0xCF, 0x20, 0xAE, 0x90, 0x52
